...
Также при сборе данных нужно будет извлечь обязанности в рамках вакансии. Они вам понадобятся во время защиты работы.
...
1. Оставить в тексте только символы кириллицы и латиницы.
